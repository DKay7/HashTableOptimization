...
SOURCES=main.cpp hash_functions_to_test.cpp ./libs/text_lib/texlib.cpp utilities.cpp
...
all: $(SOURCES)
	$(CC) $(SOURCES) $(CFLAGS) $(INCLUDE) -o $(EXECUTABLE)

fast: $(SOURCES)
		$(CC) $(SOURCES) $(CFLAGS) $(INCLUDE) $(FASTFLAGS) -o $(EXECUTABLE)
	
db: $(SOURCES)
		$(CC) $(SOURCES) $(DBFLAGS) $(INCLUDE) -o $(EXECUTABLE)
